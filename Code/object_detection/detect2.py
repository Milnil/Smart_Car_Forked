...
picam2 = Picamera2()
# Lowering resolution to reduce processing load
...
def run(model: str, max_results: int, score_threshold: float, 
    ...
    while True:
        ...
        image = cv2.resize(im, (320, 240))  # Lower resolution to reduce load
        ...
        # Run object detection using the model on every alternate frame
        if COUNTER % 2 == 0:
...
def main():
    ...
    parser.add_argument(
        ...
        required=False,
        type=int,
        default=320)  # Lower width to match capture resolution
    parser.add_argument(
        '--frameHeight',
        help='Height of frame to capture from camera.',
        required=False,
        type=int,
        default=240)  # Lower height to match capture resolution
