...
class Mapping:
    ...
    def drive_straight(self, distance_cm):
        ...
        duration = distance_cm * 0.1  # Adjust this factor based on your car's speed
    ...
    def drive_sequence(self):
        ...
        self.drive_straight(50)  # Drive straight for 50 cm
        self.turn_right()        # Turn right 90 degrees
        self.drive_straight(50)  # Drive straight again
